class CalculateComp {
    constructor( internet = 0, tv = 0, phone = 10, tier = 1, amount = 0, qtyPhone = 0, qtyTestDrive = 0, qtyYourTV = 0, qtyMostTV = 0, qtyMoreTV = 0, qtyMundo = 0, qtyMundoTotal = 0, internet200 = 20, internet400 = 0, internetGig = 0, yourFiosTV = 0, qty200 = 0, qty400 = 0, qtyGig = 0, moreFiosTV = 0, mostFiosTv = 0, testDrive = 0, mundo = 0, mundoTotal = 0 ) {
    ...
    get getAmount() {
        let amt = 0;
        let internet = ( this.internet200 * this.qty200 ) + ( this.internet400 * this.qty400 ) + ( this.internetGig * this.qtyGig );
        let tv = ( this.mostFiosTv * this.qtyMostTV ) + ( this.moreFiosTv * this.qtyMoreTV ) + ( this.mundo * this.qtyMundo ) + ( this.mundoTotal * this.qtyMundoTotal ) + ( this.yourFiosTV * this.qtyYourTV ) + ( this.testDrive * this.qtyTestDrive );
    ...
    get internetAmount() {
        return ( this.internet200 * this.qty200 ) + ( this.internet400 * this.qty400 ) + ( this.internetGig * this.qtyGig );
    }
    get tvAmount() {
        return ( this.mostFiosTv * this.qtyMostTV ) + ( this.moreFiosTv * this.qtyMoreTV ) + ( this.mundo * this.qtyMundo ) + ( this.mundoTotal * this.qtyMundoTotal ) + ( this.yourFiosTV * this.qtyYourTV ) + ( this.testDrive * this.qtyTestDrive );
    }
